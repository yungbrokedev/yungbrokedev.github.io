...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  ...
  function validate() {
    var emailInput = $(".js-form-input-email");
    var email = $(".js-form-input-email").val();

    if (validateEmail(email)) {
      emailInput.addClass("js-input-success");
      localStorage.setItem('userEmail', email);
    } else {
      emailInput.addClass("js-input-error");
    }
...
$(document).ready(function () {
  ...
  $(".product-variations__item").on('click', function () {
    ...
    $('.product-gallery').each(function (i) {
      gallery[i].slideTo(0, false, false);
    });
...
/* WEBPACK VAR INJECTION */(function($) {// import Swiper from "swiper";
$(document).ready(function () {
  ...
  $(".reviews__list .reviews__item.review").each(function (index) {
    ...
    review.attr("data-num", index); // if (reviewImagesCount > 1) {
  ...
  //     let review = $(this).parent(".review__inner")
  //     let reviewImages = review.find(".review-image")
  //     let reviewAuthor = review.find(".review__author")
  //     let reviewRating = review.find(".review__rating")
  //     let reviewText = review.find(".review__text")
  //
  //     review.parent().addClass("js-opened")
  //     $("body").addClass("overflow-hidden")
  //
  //     $("body").append("" +
  //         "<div id='modal-review' class='modal modal-is-visible modal-loading'>" +
  //
  //             "<div class='modal__body review-modal'>" +
  ...
  //     let imageMaxHeight = $(window).height()/1.6
  ...
  //
  //             let reviewGallery = new Swiper('.review-modal__swiper', {
  //                 navigation: {
